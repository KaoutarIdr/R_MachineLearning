...
pollutant("~/Downloads/specdata", "sulfate", 1:10)
...
pollutant ("~/Downloads/specdata", "sulfate", 55)
...
pollutant ("~/Downloads/specdata", "nitrate")
## [1] 1.702932
```
...
complete("~/Downloads/specdata", 50:60)
  ...
  for(i in 1:length(files))
  {
    ...
    if (nrow(cases) > threshold)
      
      {
        ...
        data_sulfate <- csv[which(!is.na(csv$sulfate)), ]
        data_nitrate <- data_sulfate[which(!is.na(data_sulfate$nitrate)), ]
        data <- c(data, cor(data_nitrate$sulfate, data_nitrate$nitrate))
...
cr <- corr("~/Downloads/specdata", 5000)
